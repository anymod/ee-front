...
module = angular.module 'ee-image-layer-editor', []

module.directive "eeImageLayerEditor", ($state, $window, $timeout, eeCollections) ->
  templateUrl: 'components/ee-image-layer-editor.html'
  restrict: 'E'
  scope:
    collection: '='
